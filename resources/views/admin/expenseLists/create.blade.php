                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="entry_date" id="entry_date" value="{{ old('entry_date') }}" required
                            class="w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm bg-gray-100 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="notes" name="notes" class="w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm bg-gray-100 ckeditor focus:ring-indigo-500 focus:border-indigo-500">{!! old('notes') !!}</textarea>
