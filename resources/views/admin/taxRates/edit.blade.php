                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.tax-rates.update", [$taxRate->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $taxRate->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('parcentage') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="parcentage" id="parcentage" value="{{ old('parcentage', $taxRate->parcentage) }}" required>
