                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.sub-cost-centers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('sub_cost_center_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="sub_cost_center_name" id="sub_cost_center_name" value="{{ old('sub_cost_center_name', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('unique_code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="unique_code" id="unique_code" value="{{ old('unique_code', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('details_of_sub_cost_center') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="details_of_sub_cost_center" id="details_of_sub_cost_center">{!! old('details_of_sub_cost_center') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('responsible_manager') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="responsible_manager" id="responsible_manager" value="{{ old('responsible_manager', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('budget_allocated') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="budget_allocated" id="budget_allocated" value="{{ old('budget_allocated', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('actual_expense') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="actual_expense" id="actual_expense" value="{{ old('actual_expense', '') }}">
