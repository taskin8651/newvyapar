...
<div class="bg-gray-100 min-h-screen py-8">
    <div class="max-w-7xl mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6">
        <form id="saleForm" action="{{ route('admin.estimate-quotations.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-2">
                        ...
                        <div class="flex flex-col">
                            <label for="due_date" class="mb-1 font-semibold"> Valid Date</label>
