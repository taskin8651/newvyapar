    ...
    <div class="bg-white shadow-lg rounded-2xl p-8">
        ...
        <div class="flex justify-between items-center border-b pb-4 mb-6">
            <h2 class="text-2xl font-bold text-indigo-600 flex items-center gap-2">
                ...
                {{ trans('global.create') }} {{ trans('cruds.cashToBank.title_singular') }}
            </h2>
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('admin.cash-to-banks.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-blue-50 p-4 rounded-lg shadow-inner">
                    <label for="from" class="block text-sm font-semibold text-gray-700 mb-1">
                        {{ trans('cruds.cashToBank.fields.from') }} <span class="text-red-500">*</span>
                    </label>
                    <input type="text" name="from" id="from" value="{{ old('from', 'Cash') }}" required
                ...
                <div class="bg-blue-50 p-4 rounded-lg shadow-inner">
                    <label for="to_id" class="block text-sm font-semibold text-gray-700 mb-1">
                        {{ trans('cruds.cashToBank.fields.to') }} <span class="text-red-500">*</span>
                    </label>
                ...
                <div class="bg-green-50 p-4 rounded-lg shadow-inner">
                    <label for="amount" class="block text-sm font-semibold text-gray-700 mb-1">
                        {{ trans('cruds.cashToBank.fields.amount') }} <span class="text-red-500">*</span>
                    </label>
