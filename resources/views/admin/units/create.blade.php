                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.units.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('base_unit') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="base_unit" id="base_unit" value="{{ old('base_unit', 'none') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('secondary_unit') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="secondary_unit" id="secondary_unit" value="{{ old('secondary_unit', 'none') }}" required>
