        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.proformaInvoice.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.proforma-invoices.update", [$proformaInvoice->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('select_customer') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="select_customer_id" id="select_customer_id" required>
                                @foreach($select_customers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('select_customer_id') ? old('select_customer_id') : $proformaInvoice->select_customer->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('billing_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="billing_name" id="billing_name" value="{{ old('billing_name', $proformaInvoice->billing_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $proformaInvoice->phone_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('e_way_bill_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="e_way_bill_no" id="e_way_bill_no" value="{{ old('e_way_bill_no', $proformaInvoice->e_way_bill_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('billing_address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="billing_address" id="billing_address">{!! old('billing_address', $proformaInvoice->billing_address) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('shipping_address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="shipping_address" id="shipping_address">{!! old('shipping_address', $proformaInvoice->shipping_address) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('po_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="po_no" id="po_no" value="{{ old('po_no', $proformaInvoice->po_no) }}">
                            @if($errors->has('po_no'))
                        ...
                        <div class="form-group {{ $errors->has('po_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="po_date" id="po_date" value="{{ old('po_date', $proformaInvoice->po_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('items') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="items[]" id="items" multiple>
                                @foreach($items as $id => $item)
                                    <option value="{{ $id }}" {{ (in_array($id, old('items', [])) || $proformaInvoice->items->contains($id)) ? 'selected' : '' }}>{{ $item }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('items'))
                        ...
                        <div class="form-group {{ $errors->has('qty') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="qty" id="qty" value="{{ old('qty', $proformaInvoice->qty) }}" step="1" required>
                            @if($errors->has('qty'))
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $proformaInvoice->description) !!}</textarea>
