            ...
            <form method="POST" 
                ...
                <div>
                    ...
                    <select name="category_type" id="category_type" required
                            class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm 
                                   focus:ring-indigo-500 focus:border-indigo-500">
                        <option value="" disabled {{ old('category_type', $expenseCategory->category_type) ? '' : 'selected' }}>
                    ...
                    @enderror
                    <p class="text-gray-500 text-sm mt-1">
                        Select whether this category is an Asset, Liability, Sale, Purchase, or Capital.
                    </p>
                </div>
                ...
                <div class="flex items-center gap-3 pt-4">
                    ...
                    <a href="{{ route('admin.expense-categories.index') }}" 
                       class="px-6 py-2 bg-gray-500 text-white font-semibold rounded 
